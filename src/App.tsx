    ...
    <div className="App">
      ...
      <main className="max-w-screen-xl flex gap-[50px] m-auto flex-col mt-[50px]">
        ...
        <section className="h-96 w-full bg-tertiaryColor flex justify-between py-[30px] px-[80px] items-center rounded-[20px]">
          ...
          <p className="w-[645px] text-white text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi odio corrupti recusandae et error eveniet laborum aliquam id praesentium consectetur sit placeat, tempore illo. Vitae sapiente quam nobis neque modi?Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi odio corrupti recusandae et error eveniet laborum aliquam id praesentium consectetur sit placeat, tempore illo. Vitae sapiente quam nobis neque modi?</p>
        </section>
